...
#include "other/classobject_c.h"

/* Forward */
static PyObject *class_lookup Py_PROTO((PyClassObject *, PyObject *, PyClassObject **)) SEG_CLASSOBJECT_C;
static PyObject *instance_getattr1 Py_PROTO((PyInstanceObject *, PyObject *)) SEG_CLASSOBJECT_C;
...
static int halfbinop Py_PROTO((PyObject *, PyObject *, char *, PyObject **,
		PyObject * (*) Py_PROTO((PyObject *, PyObject *)), int )) SEG_CLASSOBJECT_C;
...
/* jdc - free_list_count calculates the size of the free_list */
static int
free_list_count()
{
	PyMethodObject *im;
	...
	while(im != NULL) {
		count++;
		im = (PyMethodObject *)(im->im_self);
	}
	return count;
}

PyObject *
PyMethod_FreeListCount()
{
	return PyInt_FromLong((long)free_list_count());
}
