...
staticforward PyTypeObject immutable_list_type SEG_LISTOBJECT_C;
...
static PyMethodDef list_methods[] = {
	...
	{"reverse",	(PyCFunction)listreverse, 1, USE_DOC(reverse_doc)},
	{"sort",	(PyCFunction)listsort, 1, USE_DOC(sort_doc)},
	{NULL,		NULL}		/* sentinel */
};
