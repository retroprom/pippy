...
static void _inscode(PyObject *d, PyObject *de, char *name, int code) SEG_ERRNOMODULE_C;
...
DEF_DOC(errno__doc__,"This module makes available standard errno system symbols.\n\
\n\
...
DL_EXPORT(void) initerrno() SEG_ERRNOMODULE_C;

DL_EXPORT(void)
initerrno()
{
	PyObject *m, *d, *de;
	m = Py_InitModule3("errno", errno_methods, USE_DOC(errno__doc__));
