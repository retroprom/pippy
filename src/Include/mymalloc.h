...
extern ANY *malloc Py_PROTO((size_t)) SEG_MYMALLOC_H;
extern ANY *calloc Py_PROTO((size_t, size_t)) SEG_MYMALLOC_H;
extern ANY *realloc Py_PROTO((ANY *, size_t)) SEG_MYMALLOC_H;
extern void free Py_PROTO((ANY *)) SEG_MYMALLOC_H; /* XXX sometimes int on Unix old systems */
#endif
...
extern DL_IMPORT(ANY *) Py_Malloc Py_PROTO((size_t)) SEG_MYMALLOC_H;
extern DL_IMPORT(ANY *) Py_Realloc Py_PROTO((ANY *, size_t)) SEG_MYMALLOC_H;
extern DL_IMPORT(void) Py_Free Py_PROTO((ANY *)) SEG_MYMALLOC_H;

/* These wrappers around malloc *don't* call anything on failure */
extern DL_IMPORT(ANY *) PyMem_Malloc Py_PROTO((size_t)) SEG_MYMALLOC_H;
extern DL_IMPORT(ANY *) PyMem_Realloc Py_PROTO((ANY *, size_t)) SEG_MYMALLOC_H;
extern DL_IMPORT(void) PyMem_Free Py_PROTO((ANY *)) SEG_MYMALLOC_H;
