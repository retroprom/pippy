...
DL_IMPORT(void) PySys_WriteStdout(const char *format, ...) SEG_PGENHEADERS_H;
DL_IMPORT(void) PySys_WriteStderr(const char *format, ...) SEG_PGENHEADERS_H;
#else
/* Better to have no prototypes at all for varargs functions in this case */
DL_IMPORT(void) PySys_WriteStdout() SEG_PGENHEADERS_H;
DL_IMPORT(void) PySys_WriteStderr() SEG_PGENHEADERS_H;
#endif
