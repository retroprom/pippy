...
extern DL_IMPORT(PyObject *) PyInt_FromString Py_PROTO((char*, char**, int)) SEG_INTOBJECT_H;
extern DL_IMPORT(PyObject *) PyInt_FromLong Py_PROTO((long)) SEG_INTOBJECT_H;
extern DL_IMPORT(long) PyInt_AsLong Py_PROTO((PyObject *)) SEG_INTOBJECT_H;
extern DL_IMPORT(long) PyInt_GetMax Py_PROTO((void)) SEG_INTOBJECT_H;
 ...
 */
extern DL_IMPORT(unsigned long) PyOS_strtoul Py_PROTO((char *, char **, int)) SEG_INTOBJECT_H;
extern DL_IMPORT(long) PyOS_strtol Py_PROTO((char *, char **, int)) SEG_INTOBJECT_H;
