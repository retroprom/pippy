...
DL_IMPORT(void) PyErr_SetNone Py_PROTO((PyObject *)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_SetObject Py_PROTO((PyObject *, PyObject *)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_SetString Py_PROTO((PyObject *, const char *)) SEG_PYERRORS_H;
DL_IMPORT(PyObject *) PyErr_Occurred Py_PROTO((void)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_Clear Py_PROTO((void)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_Fetch Py_PROTO((PyObject **, PyObject **, PyObject **)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_Restore Py_PROTO((PyObject *, PyObject *, PyObject *)) SEG_PYERRORS_H;

/* Error testing and normalization */
DL_IMPORT(int) PyErr_GivenExceptionMatches Py_PROTO((PyObject *, PyObject *)) SEG_PYERRORS_H;
DL_IMPORT(int) PyErr_ExceptionMatches Py_PROTO((PyObject *)) SEG_PYERRORS_H;
DL_IMPORT(void) PyErr_NormalizeException Py_PROTO((PyObject**, PyObject**, PyObject**)) SEG_PYERRORS_H;
...
extern DL_IMPORT(PyObject *) PyExc_MissingFeatureError;
...
extern DL_IMPORT(int) PyErr_BadArgument Py_PROTO((void)) SEG_PYERRORS_H;
extern DL_IMPORT(PyObject *) PyErr_NoMemory Py_PROTO((void)) SEG_PYERRORS_H;
extern DL_IMPORT(PyObject *) PyErr_SetFromErrno Py_PROTO((PyObject *)) SEG_PYERRORS_H;
extern DL_IMPORT(PyObject *) PyErr_SetFromErrnoWithFilename Py_PROTO((PyObject *, char *)) SEG_PYERRORS_H;
extern DL_IMPORT(PyObject *) PyErr_Format Py_PROTO((PyObject *, const char *, ...)) SEG_PYERRORS_H;
#ifdef MS_WINDOWS
...
extern DL_IMPORT(void) PyErr_BadInternalCall Py_PROTO((void)) SEG_PYERRORS_H;

/* Function to create a new exception */
DL_IMPORT(PyObject *) PyErr_NewException Py_PROTO((char *name, PyObject *base,
				       PyObject *dict)) SEG_PYERRORS_H;

/* In sigcheck.c or signalmodule.c */
extern DL_IMPORT(int) PyErr_CheckSignals Py_PROTO((void)) SEG_PYERRORS_H;
extern DL_IMPORT(void) PyErr_SetInterrupt Py_PROTO((void)) SEG_PYERRORS_H;
