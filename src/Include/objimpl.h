...
#ifndef MS_COREDLL
extern DL_IMPORT(PyObject *) _PyObject_New Py_PROTO((PyTypeObject *)) SEG_OBJIMPL_H;
extern DL_IMPORT(PyVarObject *) _PyObject_NewVar Py_PROTO((PyTypeObject *, int)) SEG_OBJIMPL_H;
...
*/
extern DL_IMPORT(PyObject *) _PyObject_New Py_PROTO((PyTypeObject *, PyObject *)) SEG_OBJIMPL_H;
extern DL_IMPORT(PyVarObject *) _PyObject_NewVar Py_PROTO((PyTypeObject *, int, PyVarObject *)) SEG_OBJIMPL_H;
