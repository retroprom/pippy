...
static PyObject *buffer_concat Py_PROTO((PyBufferObject *self, PyObject *other));
...
static int buffer_getcharbuf Py_PROTO((PyBufferObject *self, int idx,const char ** pp));
