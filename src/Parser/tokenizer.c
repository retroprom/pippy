...
extern char *PyOS_Readline Py_PROTO((char *)) SEG_MYREADLINE_C;
...
/* Forward */
static struct tok_state *tok_new Py_PROTO((void)) SEG_TOKENIZER_C;
static int tok_nextc Py_PROTO((struct tok_state *tok)) SEG_TOKENIZER_C;
static void tok_backup Py_PROTO((struct tok_state *tok, int c)) SEG_TOKENIZER_C;
static int indenterror Py_PROTO((struct tok_state *tok )) SEG_TOKENIZER_C;
