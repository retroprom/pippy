...
/* Forward */
static void printarcs Py_PROTO((int, dfa *, FILE *)) SEG_PRINTGRAMMAR_C;
static void printstates Py_PROTO((grammar *, FILE *)) SEG_PRINTGRAMMAR_C;
static void printdfas Py_PROTO((grammar *, FILE *)) SEG_PRINTGRAMMAR_C;
static void printlabels Py_PROTO((grammar *, FILE *)) SEG_PRINTGRAMMAR_C;
