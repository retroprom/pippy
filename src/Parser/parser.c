...
static void s_reset Py_PROTO((stack *)) SEG_PARSER_C;
...
static int s_push Py_PROTO((stack *, dfa *, node *)) SEG_PARSER_C;
...
static void s_pop Py_PROTO((stack *)) SEG_PARSER_C;
...
static int shift Py_PROTO((stack *, int, char *, int, int)) SEG_PARSER_C;
...
static int push Py_PROTO((stack *, int, dfa *, int, int)) SEG_PARSER_C;
...
static int classify Py_PROTO((grammar *, int, char *)) SEG_PARSER_C;
