...
static int com_init Py_PROTO((struct compiling *, char *)) SEG_COMPILE_C;
static void com_free Py_PROTO((struct compiling *)) SEG_COMPILE_C;
static void com_push Py_PROTO((struct compiling *, int)) SEG_COMPILE_C;
static void com_pop Py_PROTO((struct compiling *, int)) SEG_COMPILE_C;
static void com_done Py_PROTO((struct compiling *)) SEG_COMPILE_C;
static void com_node Py_PROTO((struct compiling *, struct _node *)) SEG_COMPILE_C;
static void com_factor Py_PROTO((struct compiling *, struct _node *)) SEG_COMPILE_C;
static void com_addbyte Py_PROTO((struct compiling *, int)) SEG_COMPILE_C;
static void com_addint Py_PROTO((struct compiling *, int)) SEG_COMPILE_C;
static void com_addoparg Py_PROTO((struct compiling *, int, int)) SEG_COMPILE_C;
static void com_addfwref Py_PROTO((struct compiling *, int, int *)) SEG_COMPILE_C;
static void com_backpatch Py_PROTO((struct compiling *, int)) SEG_COMPILE_C;
static int com_add Py_PROTO((struct compiling *, PyObject *, PyObject *)) SEG_COMPILE_C;
static int com_addconst Py_PROTO((struct compiling *, PyObject *)) SEG_COMPILE_C;
static int com_addname Py_PROTO((struct compiling *, PyObject *)) SEG_COMPILE_C;
static void com_addopname Py_PROTO((struct compiling *, int, node *)) SEG_COMPILE_C;
static void com_list Py_PROTO((struct compiling *, node *, int)) SEG_COMPILE_C;
static int com_argdefs Py_PROTO((struct compiling *, node *)) SEG_COMPILE_C;
static int com_newlocal Py_PROTO((struct compiling *, char *)) SEG_COMPILE_C;
static PyCodeObject *icompile Py_PROTO((struct _node *, struct compiling *)) SEG_COMPILE_C;
static PyCodeObject *jcompile Py_PROTO((struct _node *, char *,
					struct compiling *)) SEG_COMPILE_C;
static PyObject *parsestrplus Py_PROTO((node *)) SEG_COMPILE_C;
static PyObject *parsestr Py_PROTO((char *)) SEG_COMPILE_C;
...
#else
	{
	com_error(co, PyExc_MissingFeatureError,
...
/* Forward */ static node *get_rawdocstring Py_PROTO((node *)) SEG_COMPILE_C;
