...
DEF_DOC(abs_doc,"abs(number) -> number\n\
\n\
...
DEF_DOC(apply_doc, "apply(object, args[, kwargs]) -> value\n\
\n\
...
DEF_DOC(buffer_doc, "buffer(object [, offset[, size]) -> object\n\
\n\
...
DEF_DOC(callable_doc, "callable(object) -> Boolean\n\
\n\
...
DEF_DOC(filter_doc, "filter(function, sequence) -> list\n\
\n\
...
DEF_DOC(chr_doc, "chr(i) -> character\n\
\n\
...
DEF_DOC(cmp_doc, "cmp(x, y) -> integer\n\
\n\
...
DEF_DOC(coerce_doc, "coerce(x, y) -> None or (x1, y1)\n\
\n\
...
DEF_DOC(compile_doc, "compile(source, filename, mode) -> code object\n\
\n\
...
DEF_DOC(complex_doc, "complex(real[, imag]) -> complex number\n\
\n\
...
DEF_DOC(dir_doc, "dir([object]) -> list of strings\n\
\n\
...
DEF_DOC(divmod_doc, "divmod(x, y) -> (div, mod)\n\
\n\
...
DEF_DOC(eval_doc, "eval(source[, globals[, locals]]) -> value\n\
\n\
...
DEF_DOC(execfile_doc, "execfile(filename[, globals[, locals]])\n\
\n\
...
DEF_DOC(getattr_doc, "getattr(object, name[, default]) -> value\n\
\n\
...
DEF_DOC(globals_doc, "globals() -> dictionary\n\
\n\
...
DEF_DOC(hasattr_doc, "hasattr(object, name) -> Boolean\n\
\n\
...
DEF_DOC(id_doc, "id(object) -> integer\n\
\n\
...
DEF_DOC(map_doc, "map(function, sequence[, sequence, ...]) -> list\n\
\n\
...
DEF_DOC(setattr_doc, "setattr(object, name, value)\n\
\n\
...
DEF_DOC(delattr_doc, "delattr(object, name)\n\
\n\
...
DEF_DOC(hash_doc, "hash(object) -> integer\n\
\n\
...
DEF_DOC(hex_doc, "hex(number) -> string\n\
\n\
...
DEF_DOC(input_doc, "input([prompt]) -> value\n\
\n\
...
DEF_DOC(intern_doc, "intern(string) -> string\n\
\n\
...
DEF_DOC(int_doc, "int(x[, base]) -> integer\n\
\n\
...
DEF_DOC(long_doc, "long(x) -> long integer\n\
...
DEF_DOC(float_doc, "float(x) -> floating point number\n\
\n\
...
DEF_DOC(len_doc, "len(object) -> integer\n\
\n\
...
DEF_DOC(list_doc, "list(sequence) -> list\n\
\n\
...
DEF_DOC(slice_doc, "slice([start,] stop[, step]) -> slice object\n\
\n\
...
DEF_DOC(locals_doc, "locals() -> dictionary\n\
\n\
...
DEF_DOC(min_doc, "min(sequence) -> value\n\
min(a, b, c, ...) -> value\n\
\n\
...
DEF_DOC(max_doc, "max(sequence) -> value\n\
max(a, b, c, ...) -> value\n\
\n\
...
DEF_DOC(oct_doc, "oct(number) -> string\n\
\n\
...
DEF_DOC(open_doc, "open(filename[, mode[, buffering]]) -> file object\n\
\n\
...
DEF_DOC(pow_doc, "pow(x, y[, z]) -> number\n\
\n\
...
DEF_DOC(range_doc, "range([start,] stop[, step]) -> list of integers\n\
\n\
...
DEF_DOC(xrange_doc, "xrange([start,] stop[, step]) -> xrange object\n\
\n\
...
DEF_DOC(raw_input_doc, "raw_input([prompt]) -> string\n\
\n\
...
DEF_DOC(reduce_doc, "reduce(function, sequence[, initial]) -> value\n\
\n\
...
DEF_DOC(reload_doc, "reload(module) -> module\n\
\n\
...
DEF_DOC(repr_doc, "repr(object) -> string\n\
\n\
...
DEF_DOC(round_doc, "round(number[, ndigits]) -> floating point number\n\
\n\
...
DEF_DOC(str_doc, "str(object) -> string\n\
\n\
...
DEF_DOC(tuple_doc, "tuple(sequence) -> list\n\
\n\
...
DEF_DOC(type_doc, "type(object) -> type object\n\
\n\
...
DEF_DOC(vars_doc, "vars([object]) -> dictionary\n\
\n\
...
DEF_DOC(isinstance_doc, "isinstance(object, class-or-type) -> Boolean\n\
\n\
...
DEF_DOC(issubclass_doc, "issubclass(C, B) -> Boolean\n\
\n\
...
PyObject *PyExc_MissingFeatureError;
...
bltin_exc[] = {
	...
	{"MissingFeatureError",&PyExc_MissingFeatureError,1},
...
DEF_DOC(builtin_doc, "Built-in functions, exceptions, and other objects.\n\
\n\
...
_PyBuiltin_Init_1()
{
	...
	mod = Py_InitModule4("__builtin__", builtin_methods,
			     USE_DOC(builtin_doc), (PyObject *)NULL,
			     PYTHON_API_VERSION);
	if (mod == NULL)
		return NULL;
